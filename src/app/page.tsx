  ...
  return (
    <div className="relative">
      ...
      {videoFinished && (
        <div
          id="main-content"
          className="flex min-h-screen flex-col items-center py-24 px-4 bg-white text-black"
          style={{ opacity: 0 }} // Start with opacity 0 for GSAP animation
        >
          <div id="mabfield" className="mt-44">
            <Mabfield />
          </div>

          {/* H2 tag animation */}
          <div className="">
            <h2 id="heading" className="text-black mt-28 font-[800] text-3xl  text-center z-10">
