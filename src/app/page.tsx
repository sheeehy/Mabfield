      ...
      <div>
        ...
        <ReactLenis root>
          <div ref={mainContentRef} className="flex min-h-screen flex-col items-center justify-center sm:pb-24 pb-8 px-4 text-black opacity-0">
            {!isMobile && (
              <div id="altVideo" className="absolute inset-0 -z-10 opacity-0 hidden sm:block" style={{ top: "-0vh" }}>
                <video className="w-full h-[102vh] mt-6 object-cover filter grayscale" src="/altVideo7.mp4" autoPlay loop muted playsInline preload="auto" />
              </div>
            )}

            <div className="z-10 text-center sm:mt-0 mt-44 pointer-events-none select-none">
              <p id="mainHeading" className="font-[900] text-[2rem] sm:text-[5rem] max-w-3xl leading-[1.1] text-black">
                MUSIC&apos;S HIDDEN GEMS.
              </p>
            </div>

            <div id="links" className="flex justify-center gap-8 sm:gap-12 mt-8 sm:mt-8 font-[500] sm:mr-6 ">
              <div className="flex-1 text-center">
                <a href="/listen" className="select-none hover:opacity-80 transition ease-in-out w-full sm:w-40  ">
              ...
              <div className="flex-1 text-center pl-0">
                <a href="/episodes" className="select-none hover:opacity-80 transition ease-in-out w-full sm:w-40">
            ...
            {isMobile && (
              <div className="mt-16">
                <Image src="/Mobile2.jpg" alt="Mobile Hero Icons" width={300} height={400} quality={100} priority={true} />
              </div>
            )}
          </div>
        </ReactLenis>
